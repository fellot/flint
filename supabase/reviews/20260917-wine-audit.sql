-- Flint: apply wine recommendation review, 2026-09-17.
...
-- Applies the reviewed factual corrections AND the clearly documented planning/culinary refinements.
...
select p.id, p.bottle, p.vintage,
  case when c.id is not null then 'updated' else p.outcome end as result,
